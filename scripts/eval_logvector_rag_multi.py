...
# -----------------------------
# NOTE:
# - expected_ids represent the CARD(s) that should be retrieved as correct answers.
# - In function-centric queries, the expected ID is the Function CARD itself,
#   even if the question mentions tables, because the evaluation targets
#   retrieval of the correct relational CARD, not literal answer generation.
# - In bidirectional queries, both function and table CARDs are treated as correct.

EVAL_DATASET: List[Dict] = [
    {
        # Table-centric query:
        # Goal: retrieve the CARD representing the wp_usermeta table and its relations
    ...
    },
    {
        ...
        # Although the question asks about accessed tables,
        # the correct retrieval target is the FUNCTION CARD itself,
        # which encapsulates its relational context (tables, calls, paths).
    ...
    {
        # Bidirectional query:
        # Both the function CARD and the related table CARD are considered correct,
        # since the query explicitly targets their relationship.
    ...
    },
    {
        ...
        # The goal is to retrieve CARDs that represent functions related to the given table.
        "query": "List all functions related to the wp_wc_admin_notes table.",
        "expected_ids": [
            "table:wp_wc_admin_notes",
            "Call_Func:AutomatticWANDataStore->read()"
        ],
        "description": "Bidirectional table–function search (multiple answers)"
    },
    {
        # Keyword-based relational query:
        # The query targets execution flow / relational context rather than a single entity.
        # Multiple CARDs capturing the data-flow relationship are treated as correct.
        ...
        "expected_ids": [
            ...
            "Call_Func:AutomatticWANDataStore->read_actions()"
        ],
